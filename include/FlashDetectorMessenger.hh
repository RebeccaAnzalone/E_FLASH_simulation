...
private:
  ...
  G4UIcmdWithoutParameter   *updateCmd, *updateCmd_d;
  G4UIcmdWithAString        *changeThePhantomMaterialCmd, *changeTheDetectorMaterialCmd; 
  G4UIcmdWith3VectorAndUnit *changeThePhantomSizeCmd;
  //G4UIcmdWith3VectorAndUnit *changeThePhantomPositionCmd;

  G4UIcmdWithADoubleAndUnit *changeThePhantomPositionCmd, *changeTheDetectorPositionCmd,*changeTheDetectorSizeCmd;
